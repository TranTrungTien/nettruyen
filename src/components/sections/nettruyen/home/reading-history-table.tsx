  ...
  return (
    <div className="visited-comics">
      <div className="box darkBox">
        <h2>
          Lịch sử đọc truyện
          <Link className="view-all" href={Constants.Routes.nettruyen.history}>
            Xem tất cả
          </Link>
        </h2>
              ...
              <li className="clearfix" key={mangaId}>
                <div className="t-item">
                  <Link
                    ...
                    href={Constants.Routes.nettruyen.manga(mangaId)}
                  >
                    <img
                      className="w-full"
                  ...
                  <h3 className="title">
                    <Link href={Constants.Routes.nettruyen.manga(mangaId)}>
                      {manga.mangaTitle}
                    </Link>
                  </h3>
                  <p className="chapter">
                    <Link
                      href={Constants.Routes.nettruyen.chapter(manga.chapterId)}
                    >
