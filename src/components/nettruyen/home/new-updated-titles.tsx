    ...
    <div className="group">
      <figure className="clearfix">
        <div className="relative mb-2">
          <Link
            title={props.title}
            href={Constants.Routes.nettruyen.manga(props.id)}
          >
            <AspectRatio
              ratio={Constants.Nettruyen.MANGA_COVER_RATIO}
        ...
        <figcaption>
          <ul className="flex flex-col gap-[4px]">
            {props.chapters.slice(0, 3).map((chapter) => (
              ...
              >
                <Link
                  href={Constants.Routes.nettruyen.chapter(chapter.id)}
