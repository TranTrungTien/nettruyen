    ...
    <DataLoader isLoading={!chapter} loadingText="Đang tải thông tin chương...">
      <div className="flex flex-col gap-0">
        ...
        <h1 className="mb-4 mt-0">
          <Link
            ...
            href={Constants.Routes.nettruyen.manga(manga?.id || "")}
          >
            {mangaTitle}
          </Link>{" "}
      ...
      <div className="reading-control">
            ...
            <div className="mrt10">
              {others.map((other, idx) => (
                <Link
                  ...
                  href={Constants.Routes.nettruyen.chapter(other)}
                >
                  Nhóm {idx}
                </Link>
              ))}
        ...
        <Alert
          ...
          title="nettruyen đang trong quá trình phát triển, trong quá trình trải nghiệm
